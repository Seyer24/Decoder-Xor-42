# ======================================================
# Autor: Arath Reyes Gonzalez
# Universidad Autonoma de Baja California
# Práctica: Desencriptado XOR
# ======================================================

# Tramas en hexadecimal
#Aqqui meter todas las tramas de paquetes que se llegan a recibir, ya se da por hecho que hasta el a0 al ser iguales es Paco
tramas = [
    "5041434f3a012d2f2d",
    "5041434f3a0a2d2e23"
]
...
# Funcion para convertir hex -> bytes -> aplicar XOR
